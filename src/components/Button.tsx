    ...
    <>
      ...
      {showArrow && (
        <div className="relative">
          ...
          <span className="text-black w-6 h-6 bg-[#FFC738] rounded-full absolute right-3 top-1/2 z-0 -translate-y-1/2 translate-x-1/2 transition-all duration-300 ease-in-out group-hover:w-20 group-hover:h-20"></span>
        </div>
      )}
    </>
  );
