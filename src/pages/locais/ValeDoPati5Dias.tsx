...
export default function ValeDoPati5Dias() {
  ...
  const dias = [
    ...
    },
    {
      ...
      text: "Gruta da lapinha, e mirante do morro do castelo. ",
      km: "12 km",
    },
    {
      dia: "4º dia de trekking",
      text: "Travessia do Vale durante o percurso.",
      km: "8 km",
    },
    {
      dia: "5º dia de trekking",
      text: "Subida do império e descida do Ramalho. Chegada em andarai.",
      km: "16 km",
    },
  ];
  ...
  return (
    <>
      <SEO
        ...
        url="/locais/ValeDoPati5Dias"
        image="/imgs/vale-do-pati.png"
        keywords="Vale do Pati, trekking 5 dias, Chapada Diamantina, trilha, Lençóis, Bahia, ecoturismo"
      />
      <OrganizationSchema />
      <TouristAttractionSchema
        name="Vale do Pati - Trekking 5 Dias"
        description="Considerado um dos trekkings mais bonitos do país, o Vale do Pati é uma travessia de 5 dias por montanhas, cachoeiras e vilas escondidas na Chapada Diamantina."
        image="https://guiamarquinhos.com/imgs/vale-do-pati.png"
        url="https://guiamarquinhos.com/locais/ValeDoPati5Dias"
      />
      <BreadcrumbListSchema
        items={[
          { name: "Início", url: "https://guiamarquinhos.com" },
          { name: "Aventuras", url: "https://guiamarquinhos.com/aventuras" },
          { name: "Vale do Pati 5 Dias", url: "https://guiamarquinhos.com/locais/ValeDoPati5Dias" },
        ]}
      />
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex flex-col items-center justify-center text-center mt-12 sm:mt-20 px-4 gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-4">
            ...
            <div className="px-6 h-[61px] rounded-[100px] bg-[#FFC737] text-lg sm:text-[22px] text-[#322F30] flex items-center justify-center gap-3">
              <Image src={Escalando} alt="Escalando" /> 62 km
            </div>
          </div>
          ...
          <div className="max-w-[1143px] w-full flex flex-col items-center justify-center gap-6 my-10">
            ...
            <div className="mt-10 flex flex-col sm:flex-row flex-wrap items-center justify-start gap-6 w-full">
              {dias.map((dia, index) => (
                <div
                  key={index}
