  ...
  return (
    <>
      ...
      <TouristAttractionSchema
        ...
        url="https://guiamarquinhos.com/aventuras/vale-do-pati-5-dias"
      />
      <BreadcrumbListSchema
        items={[
          { name: "Início", url: "https://guiamarquinhos.com" },
          { name: "Aventuras", url: "https://guiamarquinhos.com/aventuras" },
          { name: "Vale do Pati 5 Dias", url: "https://guiamarquinhos.com/aventuras/vale-do-pati-5-dias" },
        ]}
      />
          ...
          <div className="max-w-[1143px] w-full flex flex-col items-center justify-center gap-6 my-10">
            ...
            <div className="mt-10 flex flex-col sm:flex-row flex-wrap items-center justify-start gap-6 w-full">
              ...
              <div className="bg-[#e8e8de] flex-1 min-w-[280px] max-w-[367px] min-h-[400px] rounded-[40px] flex flex-col items-start justify-start gap-6 p-8 shadow-2xl">
                ...
                <p className="text-start text-[#888888] text-lg sm:text-[22px]">
                  Gruta da lapinha, e mirante do morro do castelo.
                </p>
              </div>
              <div className="bg-[#e8e8de] flex-1 min-w-[280px] max-w-[367px] min-h-[400px] rounded-[40px] flex flex-col items-start justify-start gap-6 p-8 shadow-2xl">
                <h3 className="text-[#322F30] text-2xl sm:text-[32px] font-bold">
                ...
                <p className="text-start text-[#888888] text-lg sm:text-[22px]">
                  Travessia do Vale durante o percurso.
                </p>
              </div>
              <div className="bg-[#e8e8de] flex-1 min-w-[280px] max-w-[367px] min-h-[400px] rounded-[40px] flex flex-col items-start justify-start gap-6 p-8 shadow-2xl">
                <h3 className="text-[#322F30] text-2xl sm:text-[32px] font-bold">
                ...
                <div className="px-6 h-[61px] rounded-[100px] bg-[#FFC737] text-lg sm:text-[22px] text-[#322F30] flex items-center justify-center gap-3">
                  <Image src={Escalando} alt="Escalando" /> 16 km
                </div>
                <p className="text-start text-[#888888] text-lg sm:text-[22px]">
                  Subida do império e descida do Ramalho. Chegada em andarai.
                </p>
              </div>
            </div>
